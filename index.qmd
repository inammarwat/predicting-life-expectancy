...
# message : false
model <- linear_reg() |>
  fit(Life_expectancy ~ Income_composition_of_resources + Schooling + GDP + `HIV/AIDS`, data = data)
```
...
model <- lm(Life_expectancy ~ `HIV/AIDS` + Adult_Mortality + GDP + Schooling + Income_composition_of_resources, data = data)
